/*******************************************************************************
 *
 * trimZeroOnePercentZerosAllowedPar.cpp
 *
...
int main(int argc, char * argv[]) {
    ...
    try{
        ...
        ValueArg<int>    numThreadsArg(  "w", "pthreads",   "number of worker threads", true,  1,  "integer", cmd);
        ...
        if (numThreads <= 0){
            ...
            vector<vector<int> > c =
                trimZeroOnePercentZerosAllowed(inputFile,
                                               numberOfSequences,
                                               lengthOfSequence,
            ...
            vector<vector<int> > c =
                trimZeroOnePercentZerosAllowedPar(inputFile,
                                                  numberOfSequences,
                                                  lengthOfSequence,
                                                  percentOfAllowedZerosPerSequence,
                                                  threshold,
